...
MigrationDSL.prototype = {
  ...
  , addColumn: function(collectionName, options, cb){
    ...
    //db, name, unique, collection, columns, cb
  , addIndex: function(indexName, options, cb){
    this.Dialect.addIndex(this.db, indexName, options.unique, options.table, options.columns, cb);
  }

  , dropIndex: function(collectionName, indexName, cb){
    this.Dialect.removeIndex(this.db, indexName, collectionName, cb);
  }
