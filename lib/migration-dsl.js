...
//
//    execute(this.connection, sqlStr, cb);
//  }
}

var Recorder = function(connection){
  this.connection = connection;
}
...
Recorder.prototype.execute = function execute(sql, cb){
...
module.exports = function(connection){
  ...
  var migratePatch = require("./migrate-patch")(dsl, recorder);
