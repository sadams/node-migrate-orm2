...
MigrationDSL.prototype = {
  ...
  createTable: function(collectionName, options, cb){
    ...
    for (var k in options) {
      var col = createColumn(collectionName, k, options[k], this.Dialect, this.dbDriver);
  ...
  , addColumn: function(collectionName, options, cb){
    ...
    var column = createColumn(collectionName, columnName, options[columnName], this.Dialect, this.dbDriver);
  ...
  , addPrimaryKey: function(collectionName, columnName, cb){
    this.Dialect.addPrimaryKey(this.dbDriver, collectionName, columnName, cb);
  }

  , dropPrimaryKey: function(collectionName, columnName, cb){
    this.Dialect.dropPrimaryKey(this.dbDriver, collectionName, columnName, cb);
  }

  , addForeignKey: function(collectionName, options, cb){
    this.Dialect.addForeignKey(this.dbDriver, collectionName, options, cb);
  }

  , dropForeignKey: function(collectionName, columnName, cb){
    this.Dialect.dropForeignKey(this.dbDriver, collectionName, columnName, cb);
  }
}
